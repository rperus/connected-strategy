...
try {
    ...
    Write-Host "      ⚠️  API not responding yet — UI will use demo mode gracefully." -ForegroundColor Yellow
}
...
Write-Host "╚════════════════════════════════════════════╝" -ForegroundColor Green
Write-Host ""
Write-Host "  🌐 Web UI  : http://127.0.0.1:4310" -ForegroundColor Cyan
Write-Host "  ⚙️  API     : http://127.0.0.1:4311" -ForegroundColor Cyan
Write-Host "  ❤️  Health  : http://127.0.0.1:4311/api/health" -ForegroundColor Cyan
Write-Host "  📦 Projects: http://127.0.0.1:4311/api/projects" -ForegroundColor Cyan
Write-Host ""
